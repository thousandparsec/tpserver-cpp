...
void Position3dObjectParam::packObjectFrame(OutputFrame::Ptr f, uint32_t objID){
  position.pack(f);
  f->packInt(relative);
}


bool Position3dObjectParam::unpackModifyObjectFrame(InputFrame::Ptr f, uint32_t playerid){
